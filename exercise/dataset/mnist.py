...
def _load_label(file_name):
    ...
    print('Coverting {} to Numpy Array ...'.format(file_name))
...
def load_mnist(normalize=True, flatten=True, one_hot_label=False):
    ...
    Parameters
    ----------
    normalize : Let images value to 0.0 ~ 1.0
    one_hot_label :
        if one_hot_lable=Ture, return the origin value
    ...
    if not flatten:
        for key in ('train_imag', 'test_img'):
